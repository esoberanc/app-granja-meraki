...
def leer_ultimos_registros_desde_sheets():
    try:
       ...
       # df = df.tail(1000)  # Filtrar últimos 1000 registros
        ...
        fecha_limite = pd.Timestamp.now() - pd.Timedelta(days=5)
...
3, redacta un informe corto para el cliente (máximo 5 líneas) que resuma el estado de su sistema de monitoreo, resaltando anomalías o recomendaciones si las hay, recordando que estos sensores están en una granja de tenebrio:
